...
public class Speaker {
    public String sayScore(Player player1, Player player2) {
        ...
        if (player1.getScore().getTrackPoints() >= 3 && player2.getScore().getTrackPoints() >= 3 && player1.getScore().getTrackPoints() > player2.getScore().getTrackPoints())
            return tieBreak + "ADVANTAGE: " + player1.getName();
        if (player1.getScore().getTrackPoints() >= 3 && player2.getScore().getTrackPoints() >= 3 && player2.getScore().getTrackPoints() > player1.getScore().getTrackPoints())
            return tieBreak + "ADVANTAGE: " + player2.getName();
    ...
    private String sayScore(Score score) {
        return "Games won: " + score.getNumberOfGamesWon() + " - Current game: " + WeirdTennisPoints.get(score.getTrackPoints());
    }
}
