...
public class SimulationTest {
    ...
    private final Integer FINAL_POSITION = 0;
    ...
    public void should_move_particle_one_up() {
        when(randomGenerator.nextMove()).thenReturn(1);
        assertThat(simulation.simulate(-1).run()).isEqualTo(FINAL_POSITION);
    }
    ...
    public void should_move_particle_2_up() {
        when(randomGenerator.nextMove()).thenReturn(1);
        assertThat(simulation.simulate(-2).run()).isEqualTo(FINAL_POSITION);
    ...
    public void should_move_particle_within_a_range() {
        ...
        assertThat(simulation.simulate(0).run()).isBetween(-3, 3);
    }
}
